...
const ConfiguracoesIcon = () => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <circle cx="20.5" cy="18.9" r="3.7" stroke="#0E475B" strokeWidth="2.1875" />
    <path
        ...
        >
          ...
          >
            ...
            <Image
              className={cn(
                "transition-all duration-500 ease-in-out",
                isExpanded ? "w-0 h-0 opacity-0" : "w-12 h-12 opacity-100"
              )}
              src="/br_ticket.svg" 
              alt="Logo retraído"
              width={48}
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative">
        ...
        <div
          className={cn(
            ...
            isLastActive &&
              "rounded-tr-[12px] transition-all duration-500 ease-in-out"
          )}
        />
      </div>
    </aside>
